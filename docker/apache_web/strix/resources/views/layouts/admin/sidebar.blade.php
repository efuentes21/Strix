<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
      ...
      </div></div></div></div><div class="simplebar-placeholder" style="width: 288px; height: 946px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 742px; transform: translate3d(0px, 82px, 0px); display: block;"></div></div></ul>
